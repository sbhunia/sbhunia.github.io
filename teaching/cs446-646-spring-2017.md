...
### Course Information
  ...
  - Teaching Assistant: Mustafa Solmaz
    ...
    + SI session on Programming Assignments: Monday 5:30-6:30 pm
...
|-------------|----------|---------------------------------------|---------------------|
| Mon, Jan 23 | 1        | Introduction (Chapter 1)              | Asgn 1 out          |
| Wed, Jan 25 | 2        | OS overview (Chapter 1)               |                     |
| Mon, Jan 30 |          | **Labor Day** (no classes, campus closed) |                 |
| Wed, Feb 1  | 3        | OS Structure (Chapter 2)              |                     |
| Mon, Feb 6  | 4        | Process (Chapter 3)                   |                    |
| Wed, Feb 8  | 5        | Process (Chapter 3)                   | Assgn 1 due        |
| Mon, Feb 13 | 6        | Threads (Chapter 4)                   |                     |
| Wed, Feb 15 | 7        | Threads (Chapter 4)                   |                     |
| Mon, Feb 20 | 8        | Midterm review – 1                    |                     |
| Wed, Feb 22 | 9        | **Midterm - 1**                      |                     |
| Mon, Feb 27 | 10       | Process Synchronization (Chapter 5)   |                     |
| Wed, Mar 1  | 11       | Process Synchronization (Chapter 5)   | Assgn 2 due         |
...
| Mon, Mar 20 | 16       | Main memory (chapter 8)               | Assgn 3 due         |
| Wed, Mar 22 | 17       | Main memory (chapter 8)               |                     |
| Mon, Oct 3 | 18       | Midterm review -2                     |                     |
